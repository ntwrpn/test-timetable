...
import com.java.repository.OccupationCounterCourseService;
...
public class OccupationCounterCourseController {
    ...
    private OccupationCounterCourseService orderService = new OccupationCounterCourseService();
    ...
    @PreAuthorize("hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')")
    public ResponseEntity<OccupationCounterCourse> getOccupationCounterCoursePage(Model model, @PathVariable("id") int id) {
        List<OccupationCounterCourse> orders = orderService.getById(id);
        OccupationCounterCourse order = orders.get(0);
        return new ResponseEntity<OccupationCounterCourse>(order, HttpStatus.OK);
    }
    ...
    @PreAuthorize("hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')")
    public ResponseEntity<Void> update(@PathVariable("id") int id, @RequestBody OccupationCounterCourse obj){
     obj.setId(id);
    ...
    @PreAuthorize("hasRole('ROLE_USER') or hasRole('ROLE_ADMIN')")
    public ResponseEntity<Void> DeleteOccupationCounterCourse(Model model, @PathVariable Integer id) {
