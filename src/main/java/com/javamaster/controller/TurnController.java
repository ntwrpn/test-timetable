...
import com.javamaster.domain.Turn;

import com.javamaster.repository.TurnService;
...
public class TurnController {
    ...
    public ResponseEntity<List<Turn>> getTurnPage(Model model, @PathVariable("id") int id) {
