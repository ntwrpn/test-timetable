...
import com.javamaster.domain.ClassroomType;

import com.javamaster.repository.ClassroomTypeService;
...
public class ClassroomTypeController {
    ...
    public ResponseEntity<List<ClassroomType>> getClassroomTypePage(Model model, @PathVariable("id") int id) {
